...
const CardAddModal = ({ setIsModalOpen }: CardAddModalProps) => {
  ...
  return (
    <div className='fixed inset-0 bg-black/30 bg-opacity-50 flex items-center justify-center p-4 z-50 overflow-y-hidden'>
      <div className='bg-white rounded-xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto scrollbar-none'>
